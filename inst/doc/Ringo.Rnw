...
combX <- combine(updateObject(exampleX), updateObject(smoothX))
chipAlongChrom(combX, chrom="9", xlim=c(34318000,34321000), 
               ylim=c(-2,4), probeAnno=exProbeAnno, gff=exGFF)
@
...
@
%
<<combineExpressionSetsAgi, eval=FALSE, echo=FALSE>>=
## why does this not work?
combX <- combine(updateObject(X), updateObject(smoothX))
@
...
chipAlongChrom(smoothX, probeAnno=pA, chr="17", coord=33887000+c(0, 13000),
